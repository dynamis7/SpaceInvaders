...
public class ConditionalFieldAttribute : PropertyAttribute
{
	...
	public ConditionalFieldAttribute(string propertyToCheck, object compareValue = null, float contentIndent = 0)
	{
	...
	public bool CheckAllConditions(SerializedProperty property)
	{
		return false;
	}
...
public class ConditionalFieldAttributeDrawer : PropertyDrawer
{
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		if (_toShow)
		{
			position.center += Vector2.right * _attribute.Indent;
